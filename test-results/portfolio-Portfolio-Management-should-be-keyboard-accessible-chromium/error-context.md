...
- Name: portfolio.spec.ts >> Portfolio Management >> should be keyboard accessible
- Location: tests\e2e\portfolio.spec.ts:142:7
...
Locator: locator('[data-testid="add-transaction-btn"]:focus')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="add-transaction-btn"]:focus')
  ...
  - generic [ref=e3]:
    - complementary [ref=e4]:
      - generic [ref=e5]:
        ...
        - button "Toggle sidebar" [active] [ref=e12] [cursor=pointer]:
          - img [ref=e13]
      - navigation [ref=e15]:
        - generic [ref=e16]:
          - img [ref=e17]
