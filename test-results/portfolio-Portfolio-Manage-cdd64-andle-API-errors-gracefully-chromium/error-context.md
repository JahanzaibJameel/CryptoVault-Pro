...
- Name: portfolio.spec.ts >> Portfolio Management >> should handle API errors gracefully
- Location: tests\e2e\portfolio.spec.ts:257:7
...
Locator: locator('[data-testid="error-state"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="error-state"]')
