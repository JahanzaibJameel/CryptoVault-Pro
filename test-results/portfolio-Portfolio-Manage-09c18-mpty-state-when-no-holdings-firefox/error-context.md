...
- Name: portfolio.spec.ts >> Portfolio Management >> should display empty state when no holdings
- Location: tests\e2e\portfolio.spec.ts:22:7
...
Locator: locator('[data-testid="empty-holdings"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="empty-holdings"]')
