...
- Name: portfolio.spec.ts >> Portfolio Management >> should load data from API correctly
- Location: tests\e2e\portfolio.spec.ts:234:7
...
Locator: locator('[data-testid="price-data"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="price-data"]')
