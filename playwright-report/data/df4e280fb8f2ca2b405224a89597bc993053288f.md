...
- Name: portfolio.spec.ts >> Portfolio Management >> should support internationalization
- Location: tests\e2e\portfolio.spec.ts:219:7
...
Locator: locator('[data-testid="language-selector"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="language-selector"]')
