      ...
      @if (watchlistStore.isLoading()) {
        ...
        <ui-card variant="glass" size="lg" class="empty-watchlist glass-card">
          <div class="empty-content">
            ...
            <p class="empty-description">Add cryptocurrencies from the dashboard to track their prices here.</p>
            <ui-button 
              variant="primary" 
              size="md"
              routerLink="/dashboard"
        ...
        <ui-card variant="glass" size="lg" class="watchlist-card glass-card">
          <div slot="header">
            <div class="watchlist-header-content">
              <h2 class="watchlist-count text-heading">Your Watchlist ({{ watchlistCoins().length }})</h2>
          ...
          <cdk-virtual-scroll-viewport itemSize="120" class="watchlist-viewport">
            ...
            >
              @for (coin of watchlistCoins(); track trackByCoin($index, coin)) {
                <div 
                  cdkDrag 
                  class="watchlist-item glass-item"
                ...
                >
                  <div class="coin-content">
                    ...
                    <div class="coin-price">
                      <span class="current-price text-mono">{{ formatCurrency(coin.currentPrice) }}</span>
