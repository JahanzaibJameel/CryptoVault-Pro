...
export class MarketDataStore {
  ...
  fetchTopCoins(currency: string): Promise<void> {
    ...
    return new Promise<void>((resolve, reject) => {
      this.http.get<any[]>(`${this.apiUrl}/coins/markets`, {
        params: {
  ...
  fetchGlobalMarket(currency: string): Observable<GlobalMarketData> {
    return this.http.get<any>(`${this.apiUrl}/global`).pipe(
  ...
  private mapCoinsResponse(data: any[]): Coin[] {
  ...
  private mapGlobalResponse(response: any, currency: string): GlobalMarketData {
